...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: /*'<div class="page-list">' +
        	...
        	'<ul class="am-pagination am-pagination-right" ng-show="conf.totalItems > 0">' +
        	'<span>每页{{conf.itemsPerPage}}条，共{{conf.totalItems}}条 &nbsp;&nbsp;&nbsp;&nbsp;</span>' +
        	'<li ng-class="{\'am-disabled\': conf.currentPage == 1}" ng-click="prevPage()">' +	
        	...
        	'</li>' +
        	'<li ng-class="{\'am-disabled\': conf.currentPage == conf.numberOfPages}" ng-click="nextPage()">' +		 
        ...
        link: function(scope, element, attrs){
            ...
            if(!scope.conf.perPageOptions){
                scope.conf.perPageOptions = [20, 30, 50, 100, 500];
            }
